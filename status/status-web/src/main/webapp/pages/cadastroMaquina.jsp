...
<body>
	<div class="section">
		<div class="container">
			<h4 class="title-screen">Cadastro de Maquina</h4>
			<hr />
			<div id="alertas"></div>
			<form action="salvarMaquina" method="POST" role="form">
				<div class="row">
					...
					<div class="form-group col-md-4">
						<label for="ip">IP da Maquina:</label> <input type="text"
							...
							placeholder="Digite o IP" required autofocus>
					</div>
					<div class="form-group col-md-offset-2 col-md-4">
						<label for="url">URL:</label> <input type="text"
							class="form-control" id="url" name="url"
							placeholder="Digite a URL" required autofocus>
					</div>
					<div style="clear: both;"
						class="form-group col-md-offset-2 col-md-4">
						<div class="radio">
							<label>Enviar e-mail de Status?</label> <label><input
								type="radio" name="enviarEmail" value="true" required>Sim</label>
